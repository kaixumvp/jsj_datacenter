package com.jsj.datacenter.infrastructure.common.advices;
...
import com.jsj.datacenter.infrastructure.common.text.Convert;
...
public class GlobalExceptionAdvice {
    ...
    public AjaxResult handleServiceException(ServiceException e, HttpServletRequest request) {
        ...
        return null != code && code != 0 ? AjaxResult.error(code, e.getMessage()) : AjaxResult.error(e.getMessage());
    }
